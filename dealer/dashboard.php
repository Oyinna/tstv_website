...
//get the counts
$myrec = $mycon->query("SELECT `dealer_id`, (SELECT COUNT(`dealer_id`) FROM `dealers` WHERE `dealer_type` = '0') AS dealercount_super, "
        . " (SELECT COUNT(`dealer_id`) FROM `dealers` WHERE `dealer_type` = '5') AS dealercount_sub, "
        . " (SELECT COUNT(`dealer_id`) FROM `dealers` WHERE `dealer_type` = '10') AS dealercount_retail, "
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text"><?php echo $dashboard['dealercount_super'] ?> Super</p>
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text"><?php echo $dashboard['dealercount_sub'] ?> Sub</p>
                    <p class="text-muted">Dealers</p>
                </div>
             </div>
		     </div>
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text"><?php echo $dashboard['dealercount_retail'] ?> Retailers</p>
...
?>
                                        <tr>
                                            ...
                                            <td><?php echo getDealerTypeName($row['dealer_type']) ?></td>
