...
?>                        
                          <tr>
                            <td><a href="admin_registrations-old-view.php?code=<?php echo $row['registration_id'] ?>"><?php echo $row['registration_id'] ?></a></td>
                            <td><a href="admin_registrations-old-view.php?code=<?php echo $row['registration_id'] ?>"><?php echo $row['company'] ?></a></td>
