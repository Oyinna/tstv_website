            ...
            <div id="page-inner">
                ...
                <?php } ?>
                        ...
                        <div class="form-group oneline three">
                          ...
                          <input name="country" type="text" class="form-control" id="country" value="<?php echo $retailerdetails['country'] ?>">
                        </div>
                        <div class="form-group oneline two">
                        ...
                        <div class="form-group oneline two">
                          ...
                          <input name="username" type="text" class="form-control" id="username" value="<?php echo $retailerdetails['username'] ?>" disabled>
                        </div>
                        <div class="form-group oneline two">
                      ...
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="dealer_retailers-edit">
                      </div>
