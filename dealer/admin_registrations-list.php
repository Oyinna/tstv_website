...
?>                        
                          <tr>
                            ...
                            <td><a href="admin_registrations-view.php?code=<?php echo $row['registration_id'] ?>"><?php echo $row['registration_id'] ?></a></td>
                            <td><?php echo $row['type'] ?></td>
                            <td><a href="admin_registrations-view.php?code=<?php echo $row['registration_id'] ?>"><?php echo $row['company'] ?></a></td>
