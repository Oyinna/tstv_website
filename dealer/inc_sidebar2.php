           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class=" <?php if(strpos(CurrentPageURL(),"admin_dashboard.php") !== false) echo 'active-menu' ?>"  href="admin_dashboard.php"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                    <li>
                        <a class=" <?php if(strpos(CurrentPageURL(),"managers-") !== false) echo 'active-menu' ?>" href="#"><i class="fa fa-user fa-3x"></i> Zonal Managers<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level <?php if(strpos(CurrentPageURL(),"managers-") !== false) echo 'collapse in' ?>">
                            <li>
                    ...
                    <li>
                        <a class=" <?php if(strpos(CurrentPageURL(),"dealers-") !== false) echo 'active-menu' ?>" href="#"><i class="fa fa-user fa-3x"></i> Dealers<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level <?php if(strpos(CurrentPageURL(),"dealers-") !== false) echo 'collapse in' ?>">
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level <?php if(strpos(CurrentPageURL(),"reports-") !== false) echo 'collapse in' ?>">
                            <li>
                                <a href="reports-officers.php">Dealers' Reports</a>
                            </li>
                            <li>
                                <a href="reports-incidents.php">Sales Reports</a>
                            </li>
                        </ul>
                     </li>  
                </ul>
