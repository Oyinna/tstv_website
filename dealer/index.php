...
<head>
    ...
    <title>TStv Dealer's Portal</title>
	<!-- BOOTSTRAP STYLES-->
                  ...
                  <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>   Enter Username and Password </strong>  
                            ...
                            <div class="panel-body">
                                <form role="form" action="actionmanager.php" method="post" target="actionframe">
                                       <br />
...
<iframe name="actionframe" id="actionframe" frameborder="0" width="301px" height="301px"></iframe>
