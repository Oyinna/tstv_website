...
$sql .= " AND `manager_type` = '0' ORDER BY `thedate` DESC";
...
?>                        
                          <tr>
                            <td><a href="admin_managers-view.php?code=<?php echo $row['manager_id'] ?>"><?php echo $row['manager_id'] ?></a></td>
                            <td><a href="admin_managers-view.php?code=<?php echo $row['manager_id'] ?>"><?php echo $row['name'] ?></a></td>
                            <td><a href="admin_managers-view.php?code=<?php echo $row['manager_id'] ?>"><?php echo $row['surname'].", ".$row['firstname']." ".$row['othernames'] ?></a></td>
                            <td><?php echo $row['email'] ?></td>
                            <td><?php echo $row['phone'] ?></td>
                            <td><?php echo $row['dealercount'] ?></td>
                            <td><?php echo $row['retailercount'] ?></td>
                          </tr>
<?php
}
?>                          
