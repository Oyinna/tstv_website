							...
							<div class="lx-body-main-content">
								<div class="lx-news-container">
									...
									<div class="lx-news-container-title">
                                                                            <h2><a href="channels.php">Welcome to TStv Africa</a></h2>
									</div>
									<!-- News Container Content -->
									<div class="lx-news-container-content">
										<div class="lx-clear-fix"></div>
                                                                                <p style="font-size: 16px">
                                                                                    TStv Africa is a wholly owned Nigerian innovative Pay TV Operator with refined offerings of novel Pay As You View (PAYV) subscription, pause subscription, complimentary internet service, Video call and an array of amazing TV channels with premium entertainment, informative and educative programs that cut across all
genres: News, Music, Religious, Sports, Health, Kids, Fashion and Lifestyle channels that better define the uniqueness of our diverse cultures and traditional values as a people in a single affordable bouquet.
<br /><br /><br />
                                                                                </p>
									</div>
								</div>
								<div class="lx-news-container">
									<!-- News Container Title -->
									<div class="lx-news-container-title">
                                                                            <h2><a href="channels.php">Our Channels</a></h2>
									</div>
									<!-- News Container Content -->
									<div class="lx-news-container-content">
<?php
