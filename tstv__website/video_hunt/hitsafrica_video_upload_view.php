...
$video_view = $dataRead->hitsafrica_video_list($mycon, $sql, $param);
							...
							<div class="lx-body-main-content">
								<div class="lx-news-container">
									...
									<div class="lx-news-container-title">
                                                                            <h2><a href="hitsafrica_video_upload_add.php">Add new video</a></h2>
                                                                    Search
										...
										<div class="lx-g3-f">
											...
											<div class="lx-news-item lx-mr-13">
												...
												<div class="lx-news-item-text">
													...
													<h3 style="height: 45px;"><a href="hitsafrica_video_upload-view.php?code=<?php echo $row['video_id'] ?>"><?php echo $row['video_title'] ?></a></h3>
													 by <?php echo $row['name']?> <br>    
												</div>	
                                                                                            <div class="lx-submit">
                                                                                            <a href="video/<?php echo $row['video_id'] ?>.mp4" target="_blank" download>
