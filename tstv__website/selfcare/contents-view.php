...
$contentsdetails = $dataRead->articles_get($mycon,$_GET['code']);
if(!$contentsdetails)
{
...
$picture = "pictures/articles/{$contentsdetails['article_id']}_image.jpg";
$banner = "pictures/articles/{$contentsdetails['article_id']}_banner.jpg";
								...
								<div class="lx-single-post-container">
									...
									<div class="lx-page-tree">
										<ul>
											...
											<li><a href="#"><?php echo $contentsdetails['categoryname'] ?></a></li>
											<li><i class="fa fa-caret-right"></i></li>
