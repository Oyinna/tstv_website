...
$contentsdetails = $dataRead->categories_get($mycon,$_GET['code']);
if(!$contentsdetails)
{
    openPage("index.php");
    exit;
...
$contentslist = $dataRead->articles_listbycategory($mycon, $_GET['code'], "", Array());
								...
								<div class="lx-single-post-container">
									...
									<div class="lx-page-tree">
										<ul>
											...
											<li><a href="#"><?php echo $contentsdetails['name'] ?></a></li>
										</ul>
