...
$myrec = $myconDealers->prepare("SELECT * FROM `retailers` WHERE `status` = 5 AND `country` = :country AND `state` = :state ORDER BY `company` ASC");
                ...
                <?php } ?>
								...
								<div class="lx-news-container">
									...
									<div class="lx-news-container-title">
										<h2><?php echo "$selectedstate, $selectedcountry" ?></h2>
									</div>
									<!-- News Container Content -->
										...
										<div class="lx-g4-f">
											...
											<div class="lx-news-item lx-mr-10">
												<div class="lx-news-item-text">
													...
													<p><?php echo $row['address']." ".$row['city']." ".$row['state'] ?></p>
												</div>											
											</div>
										</div>
<?php
