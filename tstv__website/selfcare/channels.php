...
$channelscategories = array();
foreach($channelslist as $row)
{
    if(!isset($channelscategories[$row['category']])) $channelscategories[$row['category']] = array();
    $channelscategories[$row['category']][] = $row;
}
					...
					<div class="lx-body-content lx-body-content-horizontal">
						<div class="lx-g3-2-f">
							...
							<div class="lx-body-main-content">
								...
								<!-- News Container -->
<?php
foreach($channelscategories as $category => $channels)
{
?>
...
?>
											<!-- News Item Sticky -->
												<div class="lx-news-item-img channels_logos">
													<a href="#"><img src="pictures/channels/<?php echo $row['channel_id'] ?>.jpg" alt="<?php echo $row['name'] ?>" /></a>
												</div>
<?php
}
?>
