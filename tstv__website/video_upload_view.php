...
$video_view = $dataRead->video_list($mycon, $sql, $param);
							...
							<div class="lx-body-main-content">
								<div class="lx-news-container">
									...
									<div class="lx-news-container-title">
                                                                            <h2><a href="video_upload_add.php">Add new video</a></h2>
                                                                    Search
										...
										<div class="lx-g3-f">
											...
											<div class="lx-news-item lx-mr-13">
												<div class="lx-news-item-img">
                                                                                                    <a href="video_upload-view.php?code=<?php echo $row['video_id'] ?>">
                                                                                                    <video controls>    
