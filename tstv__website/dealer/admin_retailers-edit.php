        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                  ...
                  <hr />
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form" enctype="multipart/form-data">
                        <div class="form-group oneline">
                          ...
                          <input name="company" type="text" class="form-control" id="company" value="<?php echo $retailerdetails['company'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="surname">Contact Surname</label>
                          <input name="surname" type="text" class="form-control" id="surname" value="<?php echo $retailerdetails['surname'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="firstname">Contact First name</label>
                          <input name="firstname" type="text" class="form-control" id="firstname" value="<?php echo $retailerdetails['firstname'] ?>">
                        </div>
                        <div class="form-group">
                          <label for="address">Address</label>
                          <textarea name="address" rows="3" class="form-control" id="address"><?php echo $retailerdetails['address'] ?></textarea>
                        </div>
                        <div class="form-group oneline three">
                          <label for="city">City</label>
                          <input name="city" type="text" class="form-control" id="city" value="<?php echo $retailerdetails['city'] ?>">
                        </div>
                        <div class="form-group oneline three">
                ...
                <?php foreach(getStatesList() as $state) { ?>
                                  <option value="<?php echo $state ?>" <?php if($state == $retailerdetails['state']) echo "selected" ?>><?php echo $state ?></option>
                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group oneline three">
                          <label for="country">Country</label>
                          <input name="country" type="text" class="form-control" id="country" value="<?php echo $retailerdetails['country'] ?>" readonly>
                        </div>
                        <div class="form-group oneline two">
                          <label for="email">Email Address</label>
                          <input name="email" type="text" class="form-control" id="email" value="<?php echo $retailerdetails['email'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="phone">Phone number</label>
                          <input name="phone" type="text" class="form-control" id="phone" value="<?php echo $retailerdetails['phone'] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group oneline two">
                          ...
                          <input name="username" type="text" class="form-control" id="username" value="<?php echo $retailerdetails['username'] ?>" readonly>
                        </div>
                        <div class="form-group oneline two">
                      ...
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="admin_retailers-edit">
                      </div>
