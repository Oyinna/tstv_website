...
//
//if(isset($_GET['bright']) && $_GET['bright'] == "okona")
//{
//    $dealerslist = $dataRead->dealers_listbyregistration($mycon);
//    foreach($dealerslist as $row)
//    {
//        $registration_id = $row['registration_id'];
//        $dealer_id = $row['dealer_id'];
//        @copy("files/registrations/{$registration_id}_cac1.jpg","files/dealers/{$dealer_id}_cac1.jpg");
//        @copy("files/registrations/{$registration_id}_cac2.jpg","files/dealers/{$dealer_id}_cac2.jpg");
//        @copy("files/registrations/{$registration_id}_cac3.jpg","files/dealers/{$dealer_id}_cac3.jpg");
//        @copy("files/registrations/{$registration_id}_file_passport.jpg","files/dealers/{$dealer_id}_file_passport.jpg");
//        @copy("files/registrations/{$registration_id}_file_office1.jpg","files/dealers/{$dealer_id}_file_office1.jpg");
//        @copy("files/registrations/{$registration_id}_file_office2.jpg","files/dealers/{$dealer_id}_file_office2.jpg");
//        @copy("files/registrations/{$registration_id}_file_office3.jpg","files/dealers/{$dealer_id}_file_office3.jpg");
//        @copy("files/registrations/{$registration_id}_file_office4.jpg","files/dealers/{$dealer_id}_file_office4.jpg");
//        
//    }
...
//check functions to process if the registration is not approved yet
if($registrationdetails['status'] == 0)
{
    if(isset($_GET['approve']) && $_GET['approve'] == "yes")
    {
        $dataWrite = New DataWrite();
        $dealer_id = $dataWrite->registrations_approve($mycon, $registrationdetails['registration_id']);
        //var_dump($done);
        if($dealer_id != false)
        {
            ...
            showAlert("The registration has been accredited.");
            openPage("admin_registrations-list.php");
            exit;
        }
        else
        {
            ...
            //if($done == 2) showAlert("This registration has already been approved.");
            //if($done == 3) showAlert("There was an error approving this registration");
            showAlert("There was an error approving this registration");
        }
    }
