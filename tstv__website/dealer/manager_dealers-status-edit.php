...
//get status history
$statuslist = $dataRead->dealers_statuslist($mycon,$dealerdetails['dealer_id']);
                  ...
                  <div class="panel panel-default">
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form">
                        <div class="form-group oneline two">
                          ...
                          <?php if($dealerdetails['status'] == "0") { ?>
                          	<option value="0" <?php if($dealerdetails['status'] == "0") echo "selected" ?>>Pending</option>
                          <?php } ?>
                            <option value="2" <?php if($dealerdetails['status'] == "2") echo "selected" ?>>Disabled</option>
                          	<option value="5" <?php if($dealerdetails['status'] == "5") echo "selected" ?>>Active</option>
                          </select>
                        </div>
                        <div class="form-group oneline two">
                        ...
                        <div class="form-group">
                          ...
                          <label for="notify">Notify dealer</label>
                        </div>
                      <div class="box-footer">
                        <button type="submit" class="btn btn-primary">Update</button>
                        <input name="command" type="hidden" id="command" value="manager_dealers-edit-status">
