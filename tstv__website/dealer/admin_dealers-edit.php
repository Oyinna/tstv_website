        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                  ...
                  <hr />
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form" enctype="multipart/form-data">
                        <div class="form-group oneline">
                          <label for="type">Select dealership type*</label>
                            <select name="type" id="type" class="form-control">
                                  <option value="Super Dealer" <?php if($dealerdetails['type'] == "Super Dealer") echo "selected" ?>>Super Dealer</option>
                                  <option value="Sub Dealer" <?php if($dealerdetails['type'] == "Sub Dealer") echo "selected" ?>>Sub Dealer</option>
                                  <option value="Retailer" <?php if($dealerdetails['type'] == "Retailer") echo "selected" ?>>Retailer</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group oneline three">
                          ...
                          <input name="othernames" type="text" class="form-control" id="othernames" value="<?php echo $dealerdetails['othernames'] ?>">
                        </div>
                        <div class="form-group oneline">
                        ...
                        <div class="form-group oneline two">
                          ...
                          <input name="owner1" type="text" class="form-control" id="owner1" value="<?php echo $dealerdetails['owner1'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="owner2">2</label>
                          <input name="owner2" type="text" class="form-control" id="owner2" value="<?php echo $dealerdetails['owner2'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="owner3">3</label>
                          <input name="owner3" type="text" class="form-control" id="owner3" value="<?php echo $dealerdetails['owner3'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="owner4">4</label>
                          <input name="owner4" type="text" class="form-control" id="owner4" value="<?php echo $dealerdetails['owner4'] ?>">
                        </div>
                        <div class="form-group oneline">
                          <label for="business_type">Type of business you are into*</label>
                          <input name="business_type" type="text" class="form-control" id="business_type" value="<?php echo $dealerdetails['business_type'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="business_duration">How long has the business been*</label>
                          <input name="business_duration" type="text" class="form-control" id="business_duration" value="<?php echo $dealerdetails['business_duration'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="business_staff">How many staff do you have*</label>
                          <input name="business_staff" type="number" class="form-control" id="business_staff" value="<?php echo $dealerdetails['business_staff'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="quantity">Current volume takeof quantity*</label>
                          <input name="quantity" type="number" class="form-control" id="quantity" value="<?php echo $dealerdetails['quantity'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="amount">Kindly state the available capital for the business*</label>
                          <input name="amount" type="number" class="form-control" id="amount" value="<?php echo $dealerdetails['amount'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="localmarket">Do you have knowledge of the local market</label>
                          <input name="localmarket" type="text" class="form-control" id="localmarket" value="<?php echo $dealerdetails['localmarket'] ?>">
                        </div>
                        <div class="form-group oneline two">
                          <label for="office">Do you have office space</label>
                            <select name="office" id="office" class="form-control">
                                  <option value="Yes" <?php if($dealerdetails['office'] == "Yes") echo "selected" ?>>Yes</option>
                                  <option value="No" <?php if($dealerdetails['office'] == "No") echo "selected" ?>>No</option>
                            </select>
                        </div>
                        <div class="form-group oneline two">
                ...
                <?php foreach(getStatesList() as $state) { ?>
                                  <option value="<?php echo $state ?>" <?php if($dealerdetails['state'] == "$state") echo "selected" ?>><?php echo $state ?></option>
                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group oneline two">
                          <label for="experience">Any experience in PayTV sales?</label>
                            <select name="experience" id="experience" class="form-control">
                                  <option value="Yes" <?php if($dealerdetails['experience'] == "Yes") echo "selected" ?>>Yes</option>
                                  <option value="No" <?php if($dealerdetails['experience'] == "No") echo "selected" ?>>No</option>
                            </select>
                        </div>
                        <div class="form-group oneline two">
                          <label for="marketting">Are you currently marketting any DTH?</label>
                            <select name="marketting" id="marketting" class="form-control">
                                  <option value="Yes" <?php if($dealerdetails['marketting'] == "Yes") echo "selected" ?>>Yes</option>
                                  <option value="No" <?php if($dealerdetails['marketting'] == "No") echo "selected" ?>>No</option>
                            </select>
                        </div>
                        <div class="form-group oneline">
                          <label for="installers">How many installers do you have?*</label>
                          <input name="installers" type="number" class="form-control" id="installers" value="<?php echo $dealerdetails['installers'] ?>">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="notes" rows="3" class="form-control" id="notes"><?php echo $dealerdetails['notes'] ?></textarea>
                        </div>
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="admin_dealers-edit">
                      </div>
