                ...
                <div class="row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      List of dealers you have registered
                    </div>
                    <!-- /.box-header -->
...
?>                        
                          <tr>
                            ...
                            <td><a href="manager_dealers-view.php?code=<?php echo $row['dealer_id'] ?>"><?php echo $row['dealer_id'] ?></a></td>
                            <td><?php echo $row['type'] ?></td>
                            <td><a href="manager_dealers-view.php?code=<?php echo $row['dealer_id'] ?>"><?php echo $row['company'] ?></a></td>
