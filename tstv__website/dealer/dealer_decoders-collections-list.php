                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Products Collections</h2>   
                        <h5>Collection of purchased decoders </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
                <div class="row">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body table-responsive">
                      <table id="tbl_collections_new" class="table table-bordered table-striped">
                        <thead>
                          <tr>
                            <th>Product</th>
                            <th>Purchased</th>
                        ...
                        <tbody>
                          <tr>
                            <td>TStv Normal Decoder</td>
                            <td>0</td>
                            <td>0</td>
                            <td>0</td>
                            <td>0</td>
                            <td><a href="dealer_decoders-collections-add.php?product=1001"><button type="button" class="btn btn-success">Request</button></a></td>
                          </tr>
                          <tr>
                            <td>TStv Internet Decoder</td>
                            <td>0</td>
                            <td>0</td>
                            <td>0</td>
                            <td>0</td>
                            <td><a href="dealer_decoders-collections-add.php?product=1002"><button type="button" class="btn btn-success">Request</button></a></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
foreach($collectionslist as $row)
{
?>                        
                          <tr>
