...
//get status history
$statuslist = $dataRead->managers_statuslist($mycon,$managerdetails['manager_id']);
                  ...
                  <div class="panel panel-default">
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form">
                        <div class="form-group oneline two">
                          ...
                          <?php if($managerdetails['status'] == "0") { ?>
                          	<option value="0" <?php if($managerdetails['status'] == "0") echo "selected" ?>>Pending</option>
                          <?php } ?>
                            <option value="2" <?php if($managerdetails['status'] == "2") echo "selected" ?>>Disabled</option>
                          	<option value="5" <?php if($managerdetails['status'] == "5") echo "selected" ?>>Active</option>
                          </select>
                        </div>
                        <div class="form-group oneline two">
                      ...
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="admin_managers-edit-status">
