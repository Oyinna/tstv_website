...
if(getUserAccessRight($currentuserid,"officers_add") <> 1)
{
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Add New Super Dealer</h2>   
                        <h5>Create a new super dealer. </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
                <div class="row">
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form" enctype="multipart/form-data">
                      ...
                      <div class="box-footer">
                        <button type="submit" class="btn btn-primary">Save Super Dealer</button>
                        <input name="command" type="hidden" id="command" value="admin_dealers-add">
                      </div>
