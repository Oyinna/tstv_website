...
//$sql .= " AND `retailer_type` = '5' ORDER BY `thedate` DESC";


$retailerslist = $dataRead->retailers_list($mycon,$sql,$param);
...
?>                        
                          <tr>
                            <td><a href="admin_retailers-view.php?code=<?php echo $row['retailer_id'] ?>"><?php echo $row['retailer_id'] ?></a></td>
