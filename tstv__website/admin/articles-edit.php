...
{
	showAlert("No articles was specified. Please click on the articles to view.");
...
$contentdetails = $dataRead->articles_get($mycon,$code);
...
function checkIfArticleHasCategory($article_categories, $category_id)
{
            ...
            <form action="actionmanager.php" method="post" target="actionframe" role="form" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="box-footer">
                      ...
                      <input name="command" type="hidden" id="command" value="articles_edit">
