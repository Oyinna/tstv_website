...
{
	showAlert("No events was specified. Please click on the event to view.");
...
$contentdetails = $dataRead->events_get($mycon,$code);
                ...
                <div class="row">
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group oneline two">
                          ...
                          <input name="eventdate" type="text" class="form-control datepicker" id="eventdate" value="<?php echo $contentdetails['eventdate'] ?>">
                        </div>
                      ...
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="events_edit">
                        <input name="event_id" type="hidden" id="event_id" value="<?php echo $contentdetails['event_id'] ?>">
                      </div>
