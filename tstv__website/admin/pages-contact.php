...
<head>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    ...
    <script type="text/javascript">bkLib.onDomLoaded(function() {
            ...
            new nicEditor({iconsPath : 'htmlEditor.gif'}).panelInstance('pages_contact_content');
    });
    </script>        
                ...
                <div class="row">
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form" enctype="multipart/form-data">
                        <div class="form-group oneline">
                          <label for="pages_contact_content">Page content</label>
                          <textarea name="contents[pages_contact_content]" rows="3" class="form-control" id="pages_contact_content"><?php echo (isset($contentsdetails['pages_contact_content'])) ? $contentsdetails['pages_contact_content'] : '' ?></textarea>
                        </div>
