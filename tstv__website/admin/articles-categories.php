...
function deleteCategory($mycon, $category_id)
{
    ...
    if(count($categorydetails['subcategories'])) return showAlert ("You must first delete all the sub categories under this category");
    if($categorydetails['articlecount'] > 0) return showAlert ("You can not delete this category because there are articles attached to it");
    $done = $dataWrite->categories_delete($mycon, $category_id);
                  ...
                  <div class="panel panel-default" id="update_div" style="display:none">
                    ...
                    <div id="step1">
                      ...
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="categories_edit">
                      </div>
                    </form>
                      </div>
...
?>                        
                          <tr>
                            ...
                            <td><a href="#" onclick="showUpdateCategory('<?php echo $row['category_id'] ?>','<?php echo $row['name'] ?>','<?php echo $row['position'] ?>'); return false;">Edit</a></td>     
                            <td>
                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="step1">
                      ...
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="categories_add">
                      </div>
                    </form>
                  </div>
                      </div>
