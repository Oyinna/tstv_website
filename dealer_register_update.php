				...
				<div class="lx-body">
								...
								<div class="lx-single-post-container">
									...
									<div class="lx-page-tree">
										<ul>
											...
											<li><a href="#">Dealers Data Validation</a></li>
										</ul>
										<div class="lx-clear-fix"></div>
									</div>
									<!-- Single Post Content -->
									<div class="lx-single-post-content" style="padding-left: 20px;">
										<h1>TStv retailer / Installer Validation form</h1>
                    <form action="dealer/actionmanager.php" method="post" target="actionframe" role="form" enctype="multipart/form-data" style="max-width: 800px">
                        <div class="form-group oneline two">
                          ...
                          <input name="formnumber" type="text" class="form-control" id="formnumber" value="1000232" disabled readonly>
                        </div>
                        <div class="form-group oneline two">
                            <label for="file">Attach completed form (<a href="dealer_validation_form.docx" target="_blank">Download Template</a>)</label>
