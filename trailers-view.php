...
{
    openPage("trailers.php");
    exit;
}

$dataRead = New DataRead();

$contentsdetails = $dataRead->trailers_get($mycon,$_GET['code']);
if(!$contentsdetails)
{
...
$contentslist = $dataRead->trailers_list($mycon, " LIMIT 6", Array());

$embedlink = preg_replace("/\s*[a-zA-Z\/\/:\.]*youtube.com\/watch\?v=([a-zA-Z0-9\-_]+)([a-zA-Z0-9\/\*\-\_\?\&\;\%\=\.]*)/i","<iframe width=\"420\" height=\"315\" src=\"//www.youtube.com/embed/$1\" frameborder=\"0\" allowfullscreen></iframe>",$contentsdetails['youtube']);
//echo $embedlink;
								...
								<div class="lx-single-post-container">
									...
									<div class="lx-single-post-content">
										...
										<div class="lx-single-post-img">
                                                                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo getYouTubeVideoId($contentsdetails['youtube']) ?>" frameborder="0" allowfullscreen></iframe>
