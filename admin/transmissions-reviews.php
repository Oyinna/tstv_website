...
//get status history
$commentslist = $dataRead->transmissions_comments_listbytransmission($mycon,$transmissiondetails['transmission_id']);
            ...
            <div id="page-inner">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                      Reviews submitted for this transmission
                    </div>
                    <!-- /.box-header -->
...
?>                        
                          <tr>
                            ...
                            <td><?php echo getTransmissionRatingName($row['rate_sound']) ?></td>
                            <td><?php echo getTransmissionRatingName($row['rate_picture']) ?></td>
                            <td><?php echo getTransmissionRatingName($row['rate_channel']) ?></td>
                            <td><?php echo $row['comment'] ?></td>
                            <td><a href="../pictures/transmissions/comments/<?php echo $row['comment_id'] ?>.jpg"><img src="../pictures/transmissions/comments/<?php echo $row['comment_id'] ?>.jpg" style="height: 150px" /></a></td>
                          </tr>
<?php
}
?>                          
