...
if(getUserAccessRight($currentuserid,"dealers_view") <> 1)
{
...
//get status history
$dealerslist = $dataRead->dealers_list($mycon,"","");
                  ...
                  <div class="panel panel-default">
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form">
                        <div class="form-group oneline">
                          <label for="transfer">Transfer all retailers of this dealer to</label>
                          <select name="transfer" class="form-control">
                          	<option value="">Select..</option>
                <?php
                    foreach($dealerslist as $row) {
                        if($row['dealer_id'] == $dealerdetails['dealer_id']) continue;
                ?>
                            <option value="<?php echo $row['dealer_id'] ?>"><?php echo $row['company']." (".$row['city']." ".$row['state'].")" ?></option>
                <?php
                    }
                ?>
                          </select>
                      ...
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="admin_dealers-delete">
