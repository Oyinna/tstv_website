...
function getTransmissionRatingName($code)
{
    $name = "Not Rated";
    if($code == "0") $name = "Very Bad";
    if($code == "1") $name = "Bad";
    if($code == "2") $name = "Good";
    if($code == "3") $name = "Very Good";
    if($code == "4") $name = "Excellent";
...
function getChannelStatusName($code)
{
    $name = "Unknown";
    if($code == "0") $name = "Suspended";
    if($code == "5") $name = "Active";
    return $name;
}
