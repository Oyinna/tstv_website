...
//get status history
$statuslist = $dataRead->transmissions_statuslist($mycon,$transmissiondetails['transmission_id']);
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form">
                        <div class="form-group oneline two">
                          ...
                          <select name="status" class="form-control">
                            <option value="0" <?php if($transmissiondetails['status'] == "0") echo "selected" ?>>Disabled</option>
                          	<option value="5" <?php if($transmissiondetails['status'] == "5") echo "selected" ?>>Active</option>
                          </select>
                        </div>
                        <div class="form-group oneline two">
                      ...
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="transmissions_edit_status">
