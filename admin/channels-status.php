...
//get status history
$statuslist = $dataRead->channels_statuslist($mycon,$channeldetails['channel_id']);
                    ...
                    <form action="actionmanager.php" method="post" target="actionframe" role="form">
                        <div class="form-group oneline two">
                          ...
                          <select name="status" class="form-control">
                            <option value="0" <?php if($channeldetails['status'] == "0") echo "selected" ?>>Disabled</option>
                          	<option value="5" <?php if($channeldetails['status'] == "5") echo "selected" ?>>Active</option>
                          </select>
                        </div>
                        <div class="form-group oneline two">
                      ...
                      <div class="box-footer">
                        ...
                        <input name="command" type="hidden" id="command" value="channels_edit_status">
