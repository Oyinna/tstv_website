							...
							<div class="lx-body-main-content">
								...
								<div class="lx-single-post-container">
									...
									<div class="lx-single-post-content">
										<h1><?php echo $contentsdetails['aboutpage_title'] ?></h1>
										<div class="lx-single-post-img">
											<img src="pictures/aboutpage_image.jpg" alt="banner" />
										</div>										
										<p><?php echo $contentsdetails['aboutpage_content'] ?></p>
										<!-- Share -->
									<!-- News Container Content -->
										<div class="lx-g3-f">
											<!-- News Item Sticky -->
											<div class="lx-news-item lx-mr-13" style="border: none;">
												<div class="lx-news-item-text">
													<h3 style="height: auto; margin: 5px 0px;"><?php echo $contentsdetails['aboutpage_box1_title'] ?></h3>
												</div>	
										...
										<div class="lx-g3-f">
											...
											<div class="lx-news-item lx-mr-13" style="border: none;">
												<div class="lx-news-item-text">
													<h3 style="height: auto; margin: 5px 0px;"><?php echo $contentsdetails['aboutpage_box2_title'] ?></h3>
												</div>	
										...
										<div class="lx-g3-f">
											...
											<div class="lx-news-item lx-mr-13" style="border: none;">
												<div class="lx-news-item-text">
													<h3 style="height: auto; margin: 5px 0px;"><?php echo $contentsdetails['aboutpage_box3_title'] ?></h3>
												</div>	
